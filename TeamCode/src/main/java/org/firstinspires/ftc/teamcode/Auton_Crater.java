...
public class Auton_Crater extends eBotsOpMode {
    ...
    private void executeCraterLeftAuton(ArrayList<DcMotor> motorList,
        ...
        /*move in front of sample*/             double [] sampleLeftMove1 = new double[] {32, -20, 0};
        //Lower latch
        /*Simple sample move*/                  double [] sampleLeftMove2 = new double[] {0, -2, 0};  //simple sample move
        /*move back a little*/                  double [] sampleLeftMove3 = new double[] {1,2,0};  //pull it back
        /*turn to align with wall*/             double sampleLeftTurn1 = 45;
        /*move toward crater and towards wall*/ double [] sampleLeftMove3_2 = new double[] {2,2,0};  //pull it back

        /*Align with wall*/                     double [] sampleLeftMove4 = new double[] {13,-13,0};
        /*turn for depot drive (overturn)*/    double sampleLeftTurn2 = 55;
        /*turn for depot drive (slight angle)*/double sampleLeftTurn3 = 45;
        ...
        /*drive to crater*/                     double [] sampleLeftMove6 = new double[] {-20,-20,0};
    ...
    private void executeCraterRightAuton(ArrayList<DcMotor> motorList,
        ...
        /*sample*/                              double [] sampleRightMove1 = new double[] {-32, -22, 0};
        //Lower latch
